...
const Guide = () => {
    ...
    return (
        <div className="bg-[#0B3A67] guide-bg">
            <div className="container mx-auto py-20 px-3 md:px-20 text-white">
                <div className="flex justify-between ">
                    <div className=" flex flex-col items-center">
                        <span className={`text-6xl pb-3 ${roboto7.className}`} >27<span className="font-normal">+</span></span>
                    ...
                    <div className=" flex flex-col items-center">
                        <span className={`text-6xl pb-3 ${roboto7.className}`} >1160<span className="font-normal">+</span></span>
                    ...
                    <div className=" flex flex-col items-center">
                        <span className={`text-6xl pb-3 ${roboto7.className}`} >18<span className="font-normal">+</span></span>
                    ...
                    <div className=" flex flex-col items-center">
                        <span className={`text-6xl pb-3 ${roboto7.className}`} >38<span className="font-normal">+</span></span>

...
const Gallery = () => {
    return (
        <div className="pt-6">
            <h4 className={`text-center uppercase text-xl lg:text-3xl text-[#0b3a67] py-4 relative after:absolute after:bottom-0 after:left-1/2 after:contents-'' after:w-2 after:h-2 after:border-t-2 after:border-l-2 after:border-[#0B3A67] after:rotate-45 ${roboto4.className}`}>Campus</h4>
                ...
                {images.map((items, index) => {
                    return (
                        <div className="w-1/2 md:w-1/3 lg:w-1/4 h-40  md:h-52 p-1  cursor-pointer relative overflow-hidden group" key={index}>
                            ...
                            <div className="text-white flex justify-center items-center text-2xl w-3/5 h-12 md:h-1/3 bg-[#0b3a67] opacity-50 absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2">

        ...
        <div className="pt-6">
            ...
            <div className="flex justify-center flex-wrap pt-6">
                {images.map((items, index) => {
                    return (
                        <div className="w-1/4 h-52 p-1  cursor-pointer relative overflow-hidden" key={index}>
                            <Image src={Img1} alt="gallery" className="transition-all w-full h-full hover:scale-125" />
                            <div className="text-white flex justify-center items-center text-2xl w-3/5 h-1/3 bg-black opacity-50 absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2">

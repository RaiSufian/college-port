            ...
            <div className="container mx-auto px-3 md:px-10 py-7 flex text-white flex-wrap">
                ...
                <div className="w-full sm:w-1/2 lg:w-1/4 pl-4 sm:pl-1 pt-3">
                    ...
                    <ul className="text-2xl mt-4 flex gap-3">
                        ...
                        <li><Link href="#"> <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48"><defs><mask id="ipSYoutube0"><g fill="none" stroke-linejoin="round"><path fill="#fff" stroke="#fff" stroke-width="4" d="M11.064 10.414c5.543-.276 9.854-.414 12.934-.414s7.393.138 12.939.415a6 6 0 0 1 5.68 5.492c.254 3.034.381 5.706.381 8.017c0 2.339-.13 5.048-.39 8.128a6 6 0 0 1-5.587 5.483c-4.741.31-9.082.465-13.023.465c-3.94 0-8.28-.155-13.018-.465a6 6 0 0 1-5.587-5.48c-.263-3.103-.395-5.814-.395-8.131c0-2.29.129-4.963.385-8.02a6 6 0 0 1 5.68-5.49Z" /><path fill="#000" stroke="#000" stroke-width="3.43" d="M21 19.61v8.796a.857.857 0 0 0 1.33.715l6.597-4.36a.857.857 0 0 0 .006-1.427l-6.598-4.436a.857.857 0 0 0-1.335.711Z" /></g></mask></defs><path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipSYoutube0)" /></svg></Link></li>
                    </ul>

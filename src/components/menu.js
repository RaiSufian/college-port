                ...
                <header className="bg-white">
                    <nav className=" flex max-w-7xl items-center justify-end lg:justify-center p-1 md:p-5 lg:px-8" aria-label="Global">
                        ...
                        <div className="hidden lg:flex lg:gap-x-8 justify-center">
                            <Link href="#" className="text-sm font-semibold leading-6 text-white rounded bg-[#0B3A67] py-1 px-3">Home</Link>
                            <Link href="#" className="text-sm font-semibold leading-6 text-gray-900 py-1 px-3 hover:bg-gray-100">labrary</Link>
                            <Link href="#" className="text-sm font-semibold leading-6 text-gray-900 py-1 px-3 hover:bg-gray-100">About Us</Link>
                            <Link href="#" className="text-sm font-semibold leading-6 text-gray-900 py-1 px-3 hover:bg-gray-100">Staf</Link>
                            <Link href="#" className="text-sm font-semibold leading-6 text-gray-900 py-1 px-3 hover:bg-gray-100">Contect Us</Link>
                        </div>
                ...
                <div className="bg-[#0B3A67] flex py-1 md:py-3 px-1 md:px-4 gap-2 md:rounded">
                    ...
                    <form className="flex-1 flex">
                        ...
                        <button className="flex justify-center items-center w-8 md:w-28 rounded-br rounded-tr bg-[#e2e0e2]">
                            <svg className="md:hidden w-6 h-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                            </svg>
